        ...
        <div className="space-y-8">
            ...
            <Card>
              <CardContent className="pt-6">
                <p className="text-muted-foreground mb-4">
                  By using OneClick Credentials, you acknowledge and agree to the collection and use of your personal 
                  information as described in this Privacy Policy. If you do not agree with these terms, please do not 
                  use our platform.
                </p>
                <p className="text-muted-foreground">
                  We may update this policy from time to time. Continued use of our service after changes constitutes 
              ...
              <CardContent className="pt-6 space-y-4">
                <div>
                  ...
                  <ul className="list-disc list-inside text-muted-foreground space-y-1">
                    <li>Full name (for document requests and identification)</li>
                    <li>Email address (for account creation and notifications)</li>
                    <li>Phone number (for SMS notifications and verification)</li>
                    <li>Student ID number (for verification with institutions)</li>
                    <li>Date of birth (for identity verification)</li>
                    <li>Current address (for document delivery if applicable)</li>
                    <li>Academic information (enrollment status, program, year level)</li>
                  </ul>
                </div>
                <div>
              ...
              <CardContent className="pt-6">
                ...
                <ul className="space-y-3 text-muted-foreground">
                  <li className="flex items-start gap-2">
                    ...
                    <span><strong>Request Processing</strong> - To process and fulfill your document requests with the school registrar</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-1">2.</span>
                    <span><strong>Identity Verification</strong> - To verify you are a legitimate student or alumni of the institution</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-1">3.</span>
                    <span><strong>Notifications</strong> - To send you email and SMS updates about your request status</span>
                  </li>
                  <li className="flex items-start gap-2">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span><strong>Customer Support</strong> - To respond to your inquiries and provide assistance</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-1">6.</span>
                    <span><strong>Service Improvement</strong> - To analyze usage patterns and improve our platform</span>
                  </li>
                  <li className="flex items-start gap-2">
              ...
              <CardContent className="pt-6 space-y-4">
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-muted/50 rounded-lg">
                    <h4 className="font-semibold text-foreground mb-2">School Registrar&apos;s Office</h4>
                    <p className="text-sm text-muted-foreground">
                      Your academic information and document requests are shared directly with the school registrar 
                      to process and fulfill your requests. This is necessary for the core functionality of our service.
                    </p>
                  </div>
                  <div className="p-4 bg-muted/50 rounded-lg">
                  ...
                  <div className="p-4 bg-muted/50 rounded-lg">
                    <h4 className="font-semibold text-foreground mb-2">Email & SMS Service Providers</h4>
                    <p className="text-sm text-muted-foreground">
                      We use third-party services to deliver email and SMS notifications about your request status.
                    </p>
                  </div>
                  <div className="p-4 bg-muted/50 rounded-lg">
                    <h4 className="font-semibold text-foreground mb-2">Legal Authorities</h4>
                    <p className="text-sm text-muted-foreground">
                      We may disclose your information when required by law, court order, or government regulation, 
                      or when necessary to protect our rights, safety, or property.
                    </p>
                  </div>
                </div>
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="p-4 border rounded-lg">
                    <h4 className="font-semibold text-foreground mb-2">Right to Opt-Out (CCPA)</h4>
                    <p className="text-sm text-muted-foreground">
                      California residents can opt-out of the sale of their personal information.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              <CardContent className="pt-6">
                <p className="text-muted-foreground">
                  ...
                  for which we collected it. Specifically:
                </p>
                <ul className="list-disc list-inside text-muted-foreground mt-4 space-y-2">
                  <li><strong>Active accounts:</strong> Data is retained as long as your account is active</li>
                  <li><strong>After account deletion:</strong> Data is retained for up to 30 days before permanent deletion</li>
                  <li><strong>Transaction records:</strong> Retained for 7 years for legal and accounting purposes</li>
                  <li><strong>Log files:</strong> Retained for 12 months for security and analytics</li>
                </ul>
              </CardContent>
            </Card>
          </section>
          ...
          <section>
            ...
            <Card>
              <CardContent className="pt-6">
                <p className="text-muted-foreground">
                  Our service is intended for students and alumni of educational institutions, typically 
                  aged 18 and above. We do not knowingly collect personal information from children under 
                  13 years of age. If you are a parent or guardian and believe we have collected information 
            ...
            <Card>
              <CardContent className="pt-6">
                <p className="text-muted-foreground">
                  ...
                  or for operational, legal, or regulatory reasons. When we make material changes, we 
